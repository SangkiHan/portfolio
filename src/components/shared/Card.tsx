...
export const Card = ({ meta, children, architectureSlot }: CardProps) => (
  <div className="bg-surface-low rounded-3xl p-4 md:p-10 border border-outline-variant/10 shadow-sm overflow-hidden">
    <div className="mb-8">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        <h4 className="text-2xl md:text-4xl font-manrope font-extrabold tracking-tightest uppercase">
          {meta.title}
        </h4>
          ...
          <div className="flex items-center gap-2">
            {meta.links.map((link) => (
              ...
              >
                ...
                {link.icon === 'googleplay' && (
                  <svg className="w-3.5 h-3.5 text-on-variant group-hover:text-primary transition-colors" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3,20.5V3.5C3,2.6,3.8,2,4.6,2.4l16,8.5c.7.4.7,1.4,0,1.8l-16,8.5C3.8,21.6,3,21,3,20.5z" />
                  </svg>
                )}
